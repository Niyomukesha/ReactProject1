...
const ContactForm = () => {
    ...
    return (
        <div style={{ fontFamily: 'Arial, sans-serif', backgroundColor: '#111', color: '#FFF', fontSize: '80px', height:'3000px' }}>
                ...
                <div className="contact-info" style={{ color: '#9f9f9f', marginTop: '12rem' }}>
                    ...
                    <div className="contact-icon" style={{ color: '#009e66' }}>
                        <div className="icon" style={{ paddingTop: '100px' }}>
                            ...
                            <span id="line"></span>
                            <div className="contact" style={{ color: '#9f9f9f', paddingLeft: '500px', position: 'absolute', top: '1500px', backgroundColor: '#111' }}>
